                ...
                <div class="row">
                                            ...
                                            <div class="card-body">
                                              <div class="user-avatar-section">
                                                <div class="d-flex flex-column align-items-center">
                                                  ...
                                                  <div class="user-info text-center">
                                                    ...
                                                    {{-- <span class="badge bg-label-secondary">{{auth()->user()->entreprise->adresse}}</span> --}}
                                                  </div>
                                                </div>
                                              </div>
                                              <div class="d-flex flex-wrap justify-content-around py-3 my-4">
                                                <div class="gap-3 d-flex align-items-start mt-3 me-4">
                                                  ...
                                                  <div>
                                                    <h5 class="mb-0">{{(auth()->user()->entreprise->walet)? auth()->user()->entreprise->walet :'0'}}</h5>
                                                    <span>Walet</span>
                                                  </div>
                                                </div>
                                                {{-- <div class="gap-3 d-flex align-items-start mt-3">
                                                  ...
                                                  <div>
                                                    <h5 class="mb-0">{{(auth()->user()->entreprise->nb_pub)? auth()->user()->entreprise->nb_pub :'0'}}</h5>
                                                    <span>Pubs Done</span>
                                                  </div>
                                                </div> --}}
                                              </div>
                                              ...
                                              <div class="info-container">
                                                <ul class="list-unstyled">
                                                  ...
                                                  <li class="mb-3">
                                                    ...
                                                    <span>{{auth()->user()->entreprise->adresse}}</span>
                                                  </li>
                                                </ul>
                  ...
                  <div class="col-md-7 col-lg-7 col-xl-8 order-0 order-md-1">
                    ...
                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                      ...
                      <li class="nav-item">
                        <a class="nav-link {{ request()->is('entreprises/profile/applied_products') ? 'active' : '' }}" href="{{route('entreprises.profile.applied_products')}}"
                    ...
                    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
                      <div class="modal-content p-3 p-md-5">
                        <div class="modal-body">
                          ...
                          <form id="editUserForm" class="row g-3" action="{{route('entreprises.updateProfile')}}" method="POST"  enctype="multipart/form-data">
                              @method('PUT')
                              @csrf
                            ...
                            <div class="col-12 col-md-6">
                              <label class="form-label" for="modalEditUserAdresse">adresse</label>
                              <div class="input-group input-group-merge">
                                <input
                                  type="text"
                                  id="modalEditUserAdresse"
                                  name="adresse"
                                  class="form-control "
                                  placeholder=""
                                  value="{{old('adresse',isset( auth()->user()->entreprise->adresse) ?  auth()->user()->entreprise->adresse :'') ?? NULL}}"
                                />
                              </div>
                            </div>
                            <div class="col-12 col-md-6">
                              <label class="form-label" for="modalEditUserlink">Link to website</label>
                              <div class="input-group input-group-merge">
                                <input
                                  type="text"
                                  ...
                                  class="form-control "
                                  placeholder=""
                                  value="{{old('link',isset( auth()->user()->entreprise->link) ?  auth()->user()->entreprise->link :'') ?? NULL}}"
                                />
                              </div>
                            </div>
                            <div class="col-12 col-md-6">
