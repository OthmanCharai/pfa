              ...
              <aside id="layout-menu" class="layout-menu-horizontal menu-horizontal menu flex-grow-0 bg-menu-theme">
                <div class="container-xxl d-flex h-100">
                  <ul class="menu-inner py-1">
                    <!-- Page -->
                    <li class="menu-item {{ request()->is('entreprises/dashbord') ? 'active' : '' }}">
                      <a href="{{route('entreprises.dashbord')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div >Dashbord</div>
                      </a>
                    </li>
                    <li class="menu-item  {{ request()->is('entreprises/profile/*') ? 'active' : '' }}">
                      <a href="{{route('entreprises.profile.account')}}" class="menu-link">
