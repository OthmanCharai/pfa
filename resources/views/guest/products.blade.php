...
@section('afterCss')
    ...
    <link rel="stylesheet" href="{{asset('temp2/css/plugins/nouislider/nouislider.css')}}">
@endsection
@section('coreJs')
    <!-- Plugins JS File -->
    ...
    <script src="{{asset('temp2/js/wNumb.js')}}"></script>
    <script src="{{asset('temp2/js/bootstrap-input-spinner.js')}}"></script>
    <script src="{{asset('temp2/js/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{asset('temp2/js/nouislider.min.js')}}"></script>
    <!-- Main JS File -->
