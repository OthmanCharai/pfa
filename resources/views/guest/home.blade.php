...
@section('afterCss')
    ...
    <link rel="stylesheet" href="{{asset('temp2/css/plugins/owl-carousel/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('temp2/css/plugins/magnific-popup/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{asset('temp2/css/plugins/jquery.countdown.css')}}">
    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{asset('temp2/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('temp2/css/skins/skin-demo-2.css')}}">
    <link rel="stylesheet" href="{{asset('temp2/css/demos/demo-2.css')}}">
@endsection
@section('coreJs')
    <!-- Plugins JS File -->
    ...
    <script src="{{asset('temp2/js/jquery.plugin.min.js')}}"></script>
    <script src="{{asset('temp2/js/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{asset('temp2/js/jquery.countdown.min.js')}}"></script>
    <!-- Main JS File -->
    <script src="{{asset('temp2/js/main.js')}}"></script>
    <script src="{{asset('temp2/js/demos/demo-2.js')}}"></script>
@endsection
@section('content')
<main class="main">
    <div class="intro-slider-container">
        <div class="owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl" data-owl-options='{"nav": false}'>
            <div class="intro-slide" style="background-image: url({{asset('temp2/images/demos/demo-2/slider/slide-1.jpg')}});">
            ...
            <div class="intro-slide" style="background-image: url({{asset('temp2/images/demos/demo-2/slider/slide-2.jpg')}});">
                <div class="container intro-content">
            ...
            <div class="intro-slide" style="background-image: url({{asset('temp2/images/demos/demo-2/slider/slide-3.jpg')}});">
                <div class="container intro-content">
    ...
    <div class="brands-border owl-carousel owl-simple" data-toggle="owl"
        ...
        <a href="#" class="brand">
            <img src="{{asset('temp2/images/brands/1.png')}}" alt="Brand Name">
        </a>

        <a href="#" class="brand">
            <img src="{{asset('temp2/images/brands/2.png')}}" alt="Brand Name">
        </a>

        <a href="#" class="brand">
            <img src="{{asset('temp2/images/brands/3.png')}}" alt="Brand Name">
        </a>

        <a href="#" class="brand">
            <img src="{{asset('temp2/images/brands/4.png')}}" alt="Brand Name">
        </a>

        <a href="#" class="brand">
            <img src="{{asset('temp2/images/brands/5.png')}}" alt="Brand Name">
        </a>

        <a href="#" class="brand">
            <img src="{{asset('temp2/images/brands/6.png')}}" alt="Brand Name">
        </a>

        <a href="#" class="brand">
            <img src="{{asset('temp2/images/brands/7.png')}}" alt="Brand Name">
        </a>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-5">
                    <div class="banner banner-large banner-overlay banner-overlay-light">
                        <a href="#">
                            <img src="{{asset('temp2/images/demos/demo-2/banners/banner-1.jpg')}}" alt="Banner">
                        </a>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="banner banner-overlay">
                        <a href="#">
                            <img src="{{asset('temp2/images/demos/demo-2/banners/banner-2.jpg')}}" alt="Banner">
                        </a>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="banner banner-overlay">
                        <a href="#">
                            <img src="{{asset('temp2/images/demos/demo-2/banners/banner-3.jpg')}}" alt="Banner">
                        </a>
                    ...
                    <div class="banner banner-overlay banner-overlay-light">
                        <a href="#">
                            <img src="{{asset('temp2/images/demos/demo-2/banners/banner-4.jpg')}}" alt="Banner">
                        </a>
                ...
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product product-11 text-center">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-1-1.jpg')}}" alt="Product image" class="product-image">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-1-2.jpg')}}" alt="Product image" class="product-image-hover">
                            </a>
                    ...
                    <div class="product product-11 text-center">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-2-1.jpg')}}" alt="Product image" class="product-image">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-2-2.jpg')}}" alt="Product image" class="product-image-hover">
                            </a>
                    ...
                    <div class="product product-11 text-center">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-3-1.jpg')}}" alt="Product image" class="product-image">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-3-2.jpg')}}" alt="Product image" class="product-image-hover">
                            </a>
                    ...
                    <div class="product product-11 text-center">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-4-1.jpg')}}" alt="Product image" class="product-image">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-4-2.jpg')}}" alt="Product image" class="product-image-hover">
                            </a>
                    ...
                    <div class="product product-11 text-center">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-5-1.jpg')}}" alt="Product image" class="product-image">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-5-2.jpg')}}" alt="Product image" class="product-image-hover">
                            </a>
                    ...
                    <div class="product product-11 text-center">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-6-1.jpg')}}" alt="Product image" class="product-image">
                                <img src="{{asset('temp2/images/demos/demo-2/temp2/product-6-2.jpg')}}" alt="Product image" class="product-image-hover">
                            </a>
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="deal">
                        ...
                        <div class="deal-image">
                            <a href="product.html">
                                <img src="{{asset('temp2/images/demos/demo-2/deal/product-1.jpg')}}" alt="image">
                            </a>
                        </div><!-- End .deal-image -->
                    </div><!-- End .deal -->
                </div><!-- End .col-lg-9 -->
                ...
                <div class="col-lg-3">
                    <div class="banner banner-overlay banner-overlay-light text-center d-none d-lg-block">
                        <a href="#">
                            <img src="{{asset('temp2/images/demos/demo-2/banners/banner-5.jpg')}}" alt="Banner">
                        </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="{{ route('guest.products') }}">
                                        ...
                                        <img src="/storage/{{$product->image }}" alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-action">
                                    <a href="{{ route('guest.products') }}" class="btn-product btn-cart"><span>View</span></a>
                                </div><!-- End .product-action -->
                            </div><!-- End .product -->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <span class="product-label label-circle label-sale">Sale</span>
                                    <a href="product.html">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-9-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-9-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <span class="product-label label-circle label-new">New</span>
                                    <a href="product.html">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-12-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-12-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-13-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-13-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-8-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-8-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-11-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-11-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-14-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-14-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-15-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-15-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-7-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-7-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-10-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-10-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-16-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('temp2/images/demos/demo-2/temp2/product-16-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
            ...
            <div class="owl-carousel owl-simple carousel-with-shadow" data-toggle="owl"
                ...
                <article class="entry entry-display">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{asset('temp2/images/demos/demo-2/blog/post-1.jpg')}}" alt="image desc">
                        </a>
                ...
                <article class="entry entry-display">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{asset('temp2/images/demos/demo-2/blog/post-2.jpg')}}" alt="image desc">
                        </a>
                    </figure><!-- End .entry-media -->
                ...
                <article class="entry entry-display">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{asset('temp2/images/demos/demo-2/blog/post-3.jpg')}}" alt="image desc">
                        </a>
                    </figure><!-- End .entry-media -->
